   ...
   //      }*/
    ...
    $scope.search=function(){
        ...
        if($scope.roundtrip == undefined)
            var URL = "http://10.0.0.175:8080/api/search?departureTime="+departure_time+"&fromStation="+$scope.from_station+"&toStation="+$scope.to_station+"&connection="+$scope.connections+"&dateOfJourney="+departure_year+"-"+departure_month+"-"+departure_date;
        ...
        else
        {
            ...
            var URL = "http://10.0.0.175:8080/api/search?departureTime="+departure_time+"&fromStation="+$scope.from_station+"&toStation="+$scope.to_station+
    ...
    $scope.confirmBooking =function(){
        ...
        var URL = "http://10.0.0.175:8080/api/transaction?userId=1";
