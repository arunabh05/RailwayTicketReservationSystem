...
public class TicketService{
    ...
    public boolean isTrainAvailable(Search train, String dateOfJourney, int numberOfPassengers){
        ...
        if(numberOfPassengers + numberOfTicketsBooked <= ticketList.get(0).getTrain().getTrain().getCapacity()){
            return true;
        }
